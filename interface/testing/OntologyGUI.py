...
# TODO implement
#        addClauseB = tk.Button(self.RLIButtonFrame, text = "Add Clause",padx = 5, bg = "#18453b",fg = self.buttonFontColor,borderwidth = 5, height = 1, width = 15 ,font = buttonFont, command = self.addClause)
#        addClauseB.pack()
    ...
    def propertyLeftClick(self,event):
        ...
        addClauseB = tk.Button(self.lcButtonFrame, text = "Add Clause",padx = 5, bg = "#18453b", fg = self.buttonFontColor,borderwidth = 5, height = 1, width = 15, font = buttonFont, command = self.addClauseAsChildofProperty)
        addClauseB.pack()
        ...
        removeConcernB = tk.Button(self.lcButtonFrame, text = "Delete",padx = 5, bg = "#18453b", fg = self.buttonFontColor,borderwidth = 5, height = 1, width = 15, font = buttonFont, command = self.removeConcern) # TODO fix this. It should remove a Property
        removeConcernB.pack()
    ...
    def clauseLeftClick(self,event):
        ...
        editName = tk.Button(self.lcButtonFrame, text = "Edit Name",padx = 5, bg = "#18453b", fg = self.buttonFontColor,borderwidth = 5, height = 1, width = 15, font = buttonFont, command = self.editClauseName)
        editName.pack()

        self.addSpace(self.lcButtonFrame,"white","tiny")

        removeClauseB = tk.Button(self.lcButtonFrame, text = "Delete",padx = 5, bg = "#18453b", fg = self.buttonFontColor,borderwidth = 5, height = 1, width = 15, font = buttonFont, command = self.removeClause)
        removeClauseB.pack()
